/**
 * API Route: Find Similar Projects
 *
 * POST /api/projects/similar
 *
 * Request body:
 * {
...
import { findSimilarProjects } from '@/lib/turso/similarity';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const results = await findSimilarProjects(queryEmbedding, limit, userId);
    ...
    console.error('Error in /api/projects/similar:', error);
    return NextResponse.json(
      {
